...
class SecurityLog(db.Model):
    ...
    severity = db.Column(db.Enum(ThreatSeverity), default=ThreatSeverity.LOW)
...
class ThreatDetection(db.Model):
    ...
    threat_type = db.Column(db.Enum(ThreatType), nullable=False)
    severity = db.Column(db.Enum(ThreatSeverity), nullable=False)
